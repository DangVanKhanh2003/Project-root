/**
 * Feature Access Orchestrator — snakeloader.com
...
/**
 * snakeloader.com geo-restricted features.
 * NOTE: Defined locally — do NOT import GEO_RESTRICTED_FEATURES from @downloader/core.
 * snakeloader.com includes download_multi (ezconv does NOT).
 */
const GEO_RESTRICTED_FEATURES = new Set([
    'download_playlist',
    'download_multi',    // ← snakeloader.com specific
    'download_channel',
]);
