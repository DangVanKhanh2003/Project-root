 ...
 *
 * Storage keys:
 *   snackeloader:license_key   → raw key string (for revalidation)
 *   snackeloader:license_cache  → {base64}.{hash} (encoded license data)
 */
...
const INTEGRITY_SALT = 'snackeloader_lk_2026';
