/**
 * Feature Access Orchestrator — y2mate.com.vc
...
/**
 * y2mate.com.vc geo-restricted features.
 * NOTE: Defined locally — do NOT import GEO_RESTRICTED_FEATURES from @downloader/core.
 * y2mate.com.vc includes download_multi (ezconv does NOT).
 */
const GEO_RESTRICTED_FEATURES = new Set([
    'download_playlist',
    'download_multi',    // ← y2mate.com.vc specific
    'download_channel',
]);
