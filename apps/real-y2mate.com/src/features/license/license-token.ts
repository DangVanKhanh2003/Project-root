 ...
 *
 * Storage keys:
 *   real-y2mate:license_key   → raw key string (for revalidation)
 *   real-y2mate:license_cache  → {base64}.{hash} (encoded license data)
 */
...
const INTEGRITY_SALT = 'real-y2mate_lk_2026';
