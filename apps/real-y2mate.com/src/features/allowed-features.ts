/**
 * Feature Access Orchestrator — real-y2mate.com
...
/**
 * real-y2mate.com geo-restricted features.
 * NOTE: Defined locally — do NOT import GEO_RESTRICTED_FEATURES from @downloader/core.
 * real-y2mate.com includes download_multi (ezconv does NOT).
 */
const GEO_RESTRICTED_FEATURES = new Set([
    'download_playlist',
    'download_multi',    // ← real-y2mate.com specific
    'download_channel',
]);
