...
const BANNER_STYLES = `
  ...
  .mp-banner-content {
    ...
    background: linear-gradient(to right, #E0F0F9, #EDF5FB, #E0F0F9);
    position: relative;
    z-index: 0;
    overflow: hidden;
    display: flex;
  ...
  :root[data-theme="dark"] .mp-banner-card-white:hover {
    border-color: rgba(74, 173, 219, 0.4);
  }
  ...
  :root[data-theme="dark"] .mp-banner-card-white:hover .mp-banner-card-icon {
    background-color: rgba(74, 173, 219, 0.15);
  }
  ...
  :root[data-theme="dark"] .mp-banner-card-white:hover .mp-banner-card-arrow {
    background-color: rgba(74, 173, 219, 0.12);
  }
`;
