 ...
 *
 * Storage keys:
 *   ytmp4:license_key   → raw key string (for revalidation)
 *   ytmp4:license_cache  → {base64}.{hash} (encoded license data)
 */
...
const LICENSE_CACHE_STORAGE_KEY = 'ytmp4:license_cache';
...
const INTEGRITY_SALT = 'ytmp4_lk_2026';
