...
|--------|---------------|-------|
| Organization | "YTMP4" (fixed) | Brand name |
| WebSite | "YTMP4" (fixed) | Site name |
| WebPage | `hero.title` (H1) | Tên trang/tool cụ thể |
| SoftwareApplication | `hero.title` (H1) | Tên tool cụ thể |

## YTMP4 Data Structure

**Lưu ý**: YTMP4 sử dụng cấu trúc data khác với y2matepro:
