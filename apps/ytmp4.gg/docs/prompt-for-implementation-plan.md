...
**Yêu cầu với implementation plan:**

1. Sắp xếp thứ tự file cần làm theo dependency (file nào phụ thuộc file nào → làm sau)
2. Mỗi file: liệt kê imports, exports, function signatures, và logic chính cần implement
3. Ghi rõ:
   - File nào **"copy/port từ ytmp3.gg"** (kèm đường dẫn file nguồn: `F:\downloader\ytmp3.gg\...`)
