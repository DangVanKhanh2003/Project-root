/**
 * Feature Access Orchestrator — tube1s.com
...
/**
 * tube1s.com geo-restricted features.
 * NOTE: Defined locally — do NOT import GEO_RESTRICTED_FEATURES from @downloader/core.
 * tube1s.com includes download_multi (ezconv does NOT).
 */
const GEO_RESTRICTED_FEATURES = new Set([
    'download_playlist',
    'download_multi',    // ← tube1s.com specific
    'download_channel',
]);
