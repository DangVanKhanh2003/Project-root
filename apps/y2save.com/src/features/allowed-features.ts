/**
 * Feature Access Orchestrator — y2save.com
...
/**
 * y2save.com geo-restricted features.
 * NOTE: Defined locally — do NOT import GEO_RESTRICTED_FEATURES from @downloader/core.
 * y2save.com includes download_multi (ezconv does NOT).
 */
const GEO_RESTRICTED_FEATURES = new Set([
    'download_playlist',
    'download_multi',    // ← y2save.com specific
    'download_channel',
]);
