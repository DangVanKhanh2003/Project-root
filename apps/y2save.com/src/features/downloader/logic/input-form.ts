    ...
    if (autoDownload) {
      ...
      if (is4K) {
        ...
        if (!limitResult.allowed) {
          showPaywall('download_4k', { secondaryLabel: 'Continue with 720p', onSecondaryClick: () => { setVideoQuality('720p'); const badge = document.querySelector('.badge-main-quality'); if (badge) badge.textContent = '720p'; setLoading(true); setSubmitting(true); handleExtractMedia(url); } });
          setSubmitting(false);
          setLoading(false);
          return;
        }
      ...
      if (is2K) {
        ...
        if (!limitResult.allowed) {
          showPaywall('download_2k', { secondaryLabel: 'Continue with 720p', onSecondaryClick: () => { setVideoQuality('720p'); const badge = document.querySelector('.badge-main-quality'); if (badge) badge.textContent = '720p'; setLoading(true); setSubmitting(true); handleExtractMedia(url); } });
          setSubmitting(false);
          setLoading(false);
          return;
        }
      ...
      if (is320kbps) {
        ...
        if (!limitResult.allowed) {
          showPaywall('download_320kbps', { secondaryLabel: 'Continue with 128kbps', onSecondaryClick: () => { setAudioBitrate('128'); const badge = document.querySelector('.badge-main-quality'); if (badge) badge.textContent = '128kbps'; setLoading(true); setSubmitting(true); handleExtractMedia(url); } });
          setSubmitting(false);
          setLoading(false);
          return;
        }
