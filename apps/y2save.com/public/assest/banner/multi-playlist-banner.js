...
const BANNER_STYLES = `
  ...
  .mp-banner-content {
    ...
    background: linear-gradient(to right, #FCE8EC, #FDF1F3, #FCE8EC);
    position: relative;
    z-index: 0;
    overflow: hidden;
    display: flex;
  ...
  :root[data-theme="dark"] .mp-banner-card-white:hover {
    border-color: rgba(240, 122, 144, 0.4);
  }
  ...
  :root[data-theme="dark"] .mp-banner-card-white:hover .mp-banner-card-icon {
    background-color: rgba(240, 122, 144, 0.15);
  }
  ...
  :root[data-theme="dark"] .mp-banner-card-white:hover .mp-banner-card-arrow {
    background-color: rgba(240, 122, 144, 0.12);
  }
`;
...
const BANNER_HTML = `
  <div class="mp-banner-content">
    ...
    <div class="mp-banner-right">
      ...
      <a href="/youtube-playlist-downloader" class="mp-banner-card mp-banner-card-white mp-banner-link-playlist">
