...
module.exports = function () {
  ...
  const pageConfigs = [
    { pageKey: 'index', slug: '' },
    { pageKey: 'save-youtube-audio', slug: 'save-youtube-audio' },
    { pageKey: 'save-youtube-shorts', slug: 'save-youtube-shorts' },
    { pageKey: 'save-youtube-video-hd', slug: 'save-youtube-video-hd' },
  ];
