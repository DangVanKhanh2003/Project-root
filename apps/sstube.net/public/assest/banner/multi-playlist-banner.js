...
const BANNER_STYLES = `
  ...
  .mp-banner-content {
    ...
    background: linear-gradient(to right, #E5EAF6, #EEF1F9, #E5EAF6);
    position: relative;
    z-index: 0;
    overflow: hidden;
    display: flex;
  ...
  :root[data-theme="dark"] .mp-banner-card-white:hover {
    border-color: rgba(107, 132, 212, 0.4);
  }
  ...
  :root[data-theme="dark"] .mp-banner-card-white:hover .mp-banner-card-icon {
    background-color: rgba(107, 132, 212, 0.15);
  }
  ...
  :root[data-theme="dark"] .mp-banner-card-white:hover .mp-banner-card-arrow {
    background-color: rgba(107, 132, 212, 0.12);
  }
`;
