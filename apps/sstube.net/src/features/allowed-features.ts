/**
 * Feature Access Orchestrator — sstube.net
...
/**
 * sstube.net geo-restricted features.
 * NOTE: Defined locally — do NOT import GEO_RESTRICTED_FEATURES from @downloader/core.
 * sstube.net includes download_multi (ezconv does NOT).
 */
const GEO_RESTRICTED_FEATURES = new Set([
    'download_playlist',
    'download_multi',    // ← sstube.net specific
    'download_channel',
]);
