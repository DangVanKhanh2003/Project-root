 ...
 * - Primary API -> if fail -> silent fallback to secondary API
 *
 * V3 flow: Create job -> Poll status -> Get download URL
 * External Extract flow: Single request -> Direct download URL
 */
