...
module.exports = function () {
  ...
  const pageConfigs = [
    { pageKey: 'index', slug: '' },
    { pageKey: 'download-4k-from-youtube', slug: 'download-4k-from-youtube' },
    { pageKey: 'download-audio-from-youtube', slug: 'download-audio-from-youtube' },
    { pageKey: 'download-mp4-from-youtube', slug: 'download-mp4-from-youtube' },
    { pageKey: 'download-shorts-from-youtube', slug: 'download-shorts-from-youtube' },
    { pageKey: 'download-video-from-youtube-android', slug: 'download-video-from-youtube-android' },
    { pageKey: 'download-video-from-youtube-iphone', slug: 'download-video-from-youtube-iphone' },
    { pageKey: 'download-video-from-youtube-link', slug: 'download-video-from-youtube-link' },
  ];
