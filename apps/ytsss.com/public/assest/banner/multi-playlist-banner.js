...
const BANNER_STYLES = `
  ...
  .mp-banner-content {
    ...
    background: linear-gradient(to right, #F0E6E2, #F6F0ED, #F0E6E2);
    position: relative;
    z-index: 0;
    overflow: hidden;
    display: flex;
  ...
  :root[data-theme="dark"] .mp-banner-card-white:hover {
    border-color: rgba(209, 151, 131, 0.4);
  }
  ...
  :root[data-theme="dark"] .mp-banner-card-white:hover .mp-banner-card-icon {
    background-color: rgba(209, 151, 131, 0.15);
  }
  ...
  :root[data-theme="dark"] .mp-banner-card-white:hover .mp-banner-card-arrow {
    background-color: rgba(209, 151, 131, 0.12);
  }
`;
