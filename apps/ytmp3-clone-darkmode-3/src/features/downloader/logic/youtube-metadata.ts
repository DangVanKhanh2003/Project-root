 ...
 */
export async function enhanceYouTubeMetadata(url: string): Promise<void> {
    ...
    try {
        // Fetch metadata from YouTube oEmbed API via @downloader/core
        ...
        const oembedData: OEmbedData = result.data as any;
 ...
 */
export async function batchEnhanceYouTubeMetadata(urls: string[]): Promise<void> {
 ...
 */
export function cancelYouTubeMetadataEnhancement(): void {
