...
export function renderPreviewCard(_data: any): void {
  ...
  const audioTrackIcon = `
    <svg xmlns="http://www.w3.org/2000/svg" width="28" height="16" viewBox="0 0 44 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon-audio-language-horizontal" aria-hidden="true" focusable="false">
