 ...
 *
 * Based on: ytmp4.gg/src/features/trustpilot/trustpilot-dark-mode.ts
 */

const TRUSTPILOT_REVIEW_URL = 'https://www.trustpilot.com/review/ssvid.cc?utm_medium=trustbox&utm_source=TrustBoxReviewCollector';
