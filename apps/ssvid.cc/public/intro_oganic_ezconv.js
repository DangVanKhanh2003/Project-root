/**
 * EzConv Intro Module (ssvid.cc edition)
...
; (function (root) {
  ...
  /* ───── CSS (scoped with .ezi- prefix, dark-theme aware) ───── */

  const CSS = `
/* EzConv Intro — scoped styles (ssvid.cc dark-theme aware) */
...
.ezi-card{
  ...
  border-radius:24px;
  border:1px solid var(--border-subtle, #E4E1DD);
...
.ezi-title{
  font-size:18px;font-weight:700;color:var(--text-heading, #000);
  letter-spacing:-.01em;line-height:1.25;margin:0;
}
.ezi-subtitle{
  font-size:14px;color:var(--text-secondary, #6B6B6B);line-height:1.6;
...
/* Search on Google */
.ezi-search-label{
  font-size:15px;font-weight:600;color:var(--text-secondary, #6B6B6B);
...
.ezi-search-bar{
  ...
  background:var(--bg-card, #fff);border:2px solid var(--border-default, #E4E1DD);border-radius:9999px;
  box-shadow:0 2px 4px rgba(0,0,0,.06);
  transition:box-shadow .2s;
  width:100%;max-width:520px;
}
.ezi-search-bar:hover{box-shadow:0 4px 8px rgba(0,0,0,.1)}
.ezi-search-icon{flex-shrink:0;color:var(--text-placeholder, #94a3b8);display:flex;align-items:center}
.ezi-search-icon svg{width:20px;height:20px}
.ezi-search-keyword{
  flex:1;font-weight:700;font-size:24px;color:var(--text-heading, #2E2E2E);
  letter-spacing:-.01em;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;
}
.ezi-copy-btn{
  display:flex;align-items:center;gap:6px;
  padding:12px 20px;
  background:#C65D3B;color:#fff;border:none;border-radius:9999px;
  font-size:12px;font-weight:700;cursor:pointer;
  transition:background .15s;white-space:nowrap;
  line-height:1;
  -webkit-tap-highlight-color:transparent;
}
.ezi-copy-btn:hover{background:#B14F2F}
.ezi-copy-btn svg{display:block}

/* Preview image */
.ezi-preview{
  margin:32px 0 16px;border-radius:16px;
  border:1px solid var(--border-subtle, #E4E1DD);box-shadow:0 1px 2px rgba(0,0,0,.05);
...
.ezi-feature svg{flex-shrink:0;color:#C65D3B}
...
.ezi-popup-footer{
  padding:16px;
  border-top:1px solid var(--border-subtle, #f1f5f9);text-align:center;
}
.ezi-popup-footer{user-select:text;-webkit-user-select:text;cursor:default}
.ezi-dismiss-btn{
  font-size:14px;font-weight:500;color:var(--text-placeholder, #94a3b8);
  background:none;border:none;cursor:pointer;
  transition:color .15s;
}
.ezi-dismiss-btn:hover{color:#C65D3B}
...
.ezi-pro-btn:hover{background:#B14F2F}
