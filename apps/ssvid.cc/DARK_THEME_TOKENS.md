# Dark Theme Tokens (ssvid.cc)

Nguon trich:
- `src/styles/variables.css` (`:root[data-theme="dark"]`)
- `src/styles/reusable-packages/package-root.css` (`[data-theme="dark"]`)

## 1) Global tokens (`variables.css`)
...
| `--background-hero-section` | `var(--bg-secondary)` |
| `--bg-page` | `#262624` |
| `--bg-card` | `#30302E` |
| `--bg-primary` | `#1F1F1E` |
| `--bg-secondary` | `#262624` |
...
| `--border-secondary` | `#4A4A48` |
| `--border-glass` | `1px solid #4A4A48` |
...
## 2) Reusable package tokens (`package-root.css`)
...
Tong so token dark theme dang override: **75**.
