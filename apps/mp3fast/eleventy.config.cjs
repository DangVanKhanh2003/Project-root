...
module.exports = function(eleventyConfig) {
  // ============================================
  // 1. WATCH TARGETS (Auto-rebuild on change)
  // ============================================
  ...
  // Import languages from allPages.cjs
  const { languages } = require('./_templates/_data/allPages.cjs');

  eleventyConfig.addGlobalData('site', {
    url: 'https://mp3fast.net',
    name: 'MP3Fast.net',
    languages: languages
  });
  ...
  // ============================================
  // 5. POST-BUILD: Copy output to final locations
  // ============================================
