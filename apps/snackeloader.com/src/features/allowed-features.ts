/**
 * Feature Access Orchestrator — snackeloader.com
...
/**
 * snackeloader.com geo-restricted features.
 * NOTE: Defined locally — do NOT import GEO_RESTRICTED_FEATURES from @downloader/core.
 * snackeloader.com includes download_multi (ezconv does NOT).
 */
const GEO_RESTRICTED_FEATURES = new Set([
    'download_playlist',
    'download_multi',    // ← snackeloader.com specific
    'download_channel',
]);
