/**
 * Feature Access Orchestrator — ytconvert.org
...
/**
 * ytconvert.org geo-restricted features.
 * NOTE: Defined locally — do NOT import GEO_RESTRICTED_FEATURES from @downloader/core.
 * ytconvert.org includes download_multi (ezconv does NOT).
 */
const GEO_RESTRICTED_FEATURES = new Set([
    'download_playlist',
    'download_multi',    // ← ytconvert.org specific
    'download_channel',
]);
