...
module.exports = function () {
  ...
  const pageConfigs = [
    { pageKey: 'index', slug: '' },
    { pageKey: 'youtube-to-mp3-converter', slug: 'youtube-to-mp3-converter' },
    { pageKey: 'youtube-to-mp4-converter', slug: 'youtube-to-mp4-converter' },
    { pageKey: 'youtube-audio-converter', slug: 'youtube-audio-converter' },
    { pageKey: 'youtube-playlist-to-mp3', slug: 'youtube-playlist-to-mp3' },
    { pageKey: 'youtube-shorts-to-mp4', slug: 'youtube-shorts-to-mp4' },
    { pageKey: 'youtube-to-mp3-320kbps', slug: 'youtube-to-mp3-320kbps' },
    { pageKey: 'youtube-to-mp4-4k', slug: 'youtube-to-mp4-4k' },
    { pageKey: 'youtube-to-mp4-hd', slug: 'youtube-to-mp4-hd' },
  ];
