 ...
 * A self-contained banner with 1 card:
 * 1. Download Playlist -> youtube-playlist-to-mp3
 * 
 * Usage:
...
const BANNER_STYLES = `
  ...
  .mp-banner-content {
    ...
    background: linear-gradient(to right, #DFF0EC, #ECF5F3, #DFF0EC);
    position: relative;
    z-index: 0;
    overflow: hidden;
    display: flex;
...
const BANNER_HTML = `
  <div class="mp-banner-content">
    ...
    <div class="mp-banner-right">
      ...
      <a href="/youtube-playlist-to-mp3" class="mp-banner-card mp-banner-card-white mp-banner-link-playlist">
...
function createBannerElement(options = {}) {
    ...
    const {
        playlistPath = '/youtube-playlist-to-mp3',
        playlistParams = {}
    } = options;
